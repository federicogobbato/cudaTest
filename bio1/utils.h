...
#define checkCudaErrorsAndExit(val) checkAndExit( (val), #val, __FILE__, __LINE__)
#define checkCudaErrors(val) check( (val), #val, __FILE__, __LINE__)


template<typename T>
void checkAndExit(T err, const char* const func, const char* const file, const int line) {
  if (err != cudaSuccess) {
